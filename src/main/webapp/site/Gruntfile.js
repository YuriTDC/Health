...
module.exports = function (grunt) {
	...
	grunt.initConfig({
		...
		// replace dev url's for distribution
		replace: {
			dist: {
				src: ['dist/scripts/*.js'], // source files array (supports minimatch)
				dest: 'dist/scripts/', // destination directory or file
				replacements: [{
					from: '/email-overview', // string replacement
					to: ''
				}]
			}
		},
