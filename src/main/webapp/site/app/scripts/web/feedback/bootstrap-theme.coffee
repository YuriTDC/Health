###
Created by rafael on 3/10/14.
###
(($) ->

	# $.noty.defaults.callback = {
	#      onShow:function () {
	#      	style = $(this.options.layout.container.selector).prop("style");
	#      	style.top = "";
	#      	$(this.options.layout.container.selector).hide().addClass('noty-out').show();
	#      },
	#      afterShow:function () {
	#      	$(this.options.layout.container.selector).addClass('noty-in');
	#      },
	#      onClose:function () {
	#      	$(this.options.layout.container.selector).removeClass('noty-in');
	#      }
	#  }
	...
	$.noty.themes.twitter_bootstrap =
		...
		style: ->
			$container = $(@options.layout.container.selector)
			@$bar.css
				overflow: "hidden"
				padding: "5px"
			...
			switch @options.type
				when "alert", "notification"
					@$bar.css border: "#FBEED5 solid 1px"
					@$bar.css
				...
				when "error"
					@$bar.css border: "#EED3D7 solid 1px"
					@$bar.css
				...
				when "information"
					@$bar.css border: "#BCE8F1 solid 1px"
					@$bar.css
				...
				when "success"
					@$bar.css border: "#D6E9C6 solid 1px"
					@$bar.css
