...
.controller 'RepositorioColaboradoresController',['$scope', '$location', '$filter', '$stateParams', '$timeout', '$http', 'urlConfig', 'clientes', '$state', 'listaClientes', 'time', 'integrantes','RepositorioService', 'faseProjetoResolve','Feedback',
($scope, $location, $filter, $stateParams, $timeout, $http, urlConfig, clientes, $state, listaClientes, time, integrantes, RepositorioService, Feedback, faseProjetoResolve)->
